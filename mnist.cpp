...
int main(int argc, char* argv[]) {
  ...
  // load MNIST training data using MNIST loader by Nuri Park
  // data is loaded as an array of structs, each struct contains image and label
  ...
  // load MNIST test data using MNIST loader by Nuri Park
  ...
  // put loaded test data into a more standard format for training (same as above)
